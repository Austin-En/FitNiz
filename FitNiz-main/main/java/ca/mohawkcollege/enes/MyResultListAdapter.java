...
public class MyResultListAdapter extends ArrayAdapter<String> {
     ...
     * @param context
     * @param metrics This contains strings of all of the metrics for the textfields
     * @param values This contains the values to be displayed such as time spent on the workout/cardio
     */
    public MyResultListAdapter(Context context, String[] metrics, String[] values) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        textView.setText(metrics[position]);
